...
Execute the following batch command to install the core software suite:
...
* **VLC**: A versatile cross-platform media player and streaming server.
* **GIMP**: Professional-grade GNU Image Manipulation Program for graphic design.
* **qBittorrent**: Lightweight, ad-free BitTorrent client for file management.
* **GNOME Tweaks**: Essential GUI for advanced desktop environment configuration (fonts, themes, and extensions).
